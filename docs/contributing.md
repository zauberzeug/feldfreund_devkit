...
If you encounter a bug or other issue, the best way to report it is by opening a new issue on our [GitHub repository](https://github.com/zauberzeug/feldfreund).
...
We follow a [Code of Conduct](https://github.com/zauberzeug/feldfreund/blob/main/CODE_OF_CONDUCT.md) to ensure that everyone who participates in the NiceGUI community feels welcome and safe.
...
Alternatively you can use VSCode, open the feldfreund.code-workspace file and install the recommended extensions.
