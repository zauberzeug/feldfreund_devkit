...
def create_drive_parameters(*, linear_speed_limit: float = 0.3,
                            ...
                            throttle_at_end_min_speed: float = 0.08) -> DriveParameters:
    return DriveParameters(linear_speed_limit=linear_speed_limit,
                           ...
                           max_detection_age_ramp=max_detection_age_ramp,
                           ...
                           curvature_feedforward_gain=curvature_feedforward_gain,
