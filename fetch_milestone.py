...
BASE_URL = 'https://api.github.com/repos/zauberzeug/feldfreund_devkit'
...
for issue in issues:
    ...
    number_patterns = [r'#(\d+)', r'https://github.com/zauberzeug/feldfreund_devkit/(?:issues|discussions|pulls)/(\d+)']
