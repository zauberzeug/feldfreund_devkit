...
from route_helpers import TOOL_OFFSET, OneLegNavigation, RowTurnRowNavigation, until
...
async def test_a_stop_holds_the_robot_and_then_resumes(devkit_system) -> None:
    ...
    orchestrator = Orchestrator(OneLegNavigation(), devkit_system.driver, devkit_system.robot_locator, work=never)
    at_rest: list[float] = []
