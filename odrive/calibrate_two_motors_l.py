...
for i, axis in enumerate([odrv0.axis0, odrv0.axis1]):
    ...
    assert_equal(axis.motor.config.calibration_current, 10)
    ...
    assert_equal(axis.controller.config.vel_gain, 25)
    assert_equal(axis.controller.config.vel_integrator_gain, 40)
